...
import {creatingSpecs, getAllSpecs} from "../controller_functions/specController.js"
...
router.post('/spec', creatingSpecs)
// router.get('/:id', getSpec)

router.get("/controller_functions/infraImport/infra", users);
